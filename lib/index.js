 ...
 *                  - queueOptions {Object} Optional. Parameters for ldapjs
 *                    client RequestQueue:
 *                    - size {Number} maximum size
 *                    - timeout {Number} maximum time (ms) the queue can be
 *                      non-empty before indicating failure to pending requests
